...
(function () {
  ...
  /* ---------- 1b. tamanho do player ----------
     ...
     Computador: cresce alem do container da pagina, ate 860px.
     ------------------------------------------------ */
  function porTamanho() {
    var css = document.createElement("style");
    css.textContent =
      "vturb-smartplayer{display:block;width:100%;margin:0 auto;border-radius:14px;overflow:hidden}" +
      "@media(max-width:700px){" +
        "vturb-smartplayer{width:100vw;margin-left:calc(50% - 50vw);" +
        "margin-right:calc(50% - 50vw);border-radius:0}" +
      "}" +
      "@media(min-width:701px){" +
        "vturb-smartplayer{width:min(860px,92vw);margin-left:50%;" +
